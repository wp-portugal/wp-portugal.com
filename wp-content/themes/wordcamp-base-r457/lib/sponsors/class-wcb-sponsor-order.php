...
class WCB_Sponsor_Order extends WCB_Loader {
	...
	function admin_menu() {
		$page = add_submenu_page(
			...
			__('Order Sponsor Levels', 'wcb'),              // Page title
			__('Order Sponsor Levels', 'wcb'),              // Menu title
	...
	function render() {
		...
		<div class="wrap">
			<?php screen_icon(); ?>
			<h2><?php _e( 'Order Sponsor Levels', 'wcb' ); ?></h2>
			...
			<form method="post" action="options.php">
				...
				<div class="description sponsor-order-instructions">
					<?php _e('Change the order of sponsor levels are displayed in the sponsors page template.', 'wcb'); ?>
				</div>
