...
function twentyten_posted_on() {
	$meta = array();
	$meta['author'] = sprintf( __( '%1$s <span class="meta-sep">by</span> %2$s', 'twentyten' ),
	...
	$meta['comments'] = array(
		...
		'after'     => '</span>',
		'zero'      => __( 'Leave a comment', 'twentyten' ),
		'one'       => __( '1 Comment', 'twentyten' ),
		'many'      => __( '% Comments', 'twentyten' ),
	);

	$meta['edit'] = array(
		'title'     => __( 'Edit', 'twentyten' ),
