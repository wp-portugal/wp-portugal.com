 ...
 */
class Monolog_Formatter_HtmlFormatter extends Monolog_Formatter_NormalizerFormatter
{
    /**
     * Translates Monolog log levels to html color priorities.
     */
    private $logLevels = array(
        Monolog_Logger::DEBUG     => '#cccccc',
        Monolog_Logger::INFO      => '#468847',
        Monolog_Logger::NOTICE    => '#3a87ad',
        Monolog_Logger::WARNING   => '#c09853',
        Monolog_Logger::ERROR     => '#f0ad4e',
        Monolog_Logger::CRITICAL  => '#FF7708',
        Monolog_Logger::ALERT     => '#C12A19',
        Monolog_Logger::EMERGENCY => '#000000',
    );
