 ...
 * @internal
 */
class Symfony_Process_Pipes_WindowsPipes extends Symfony_Process_Pipes_AbstractPipes
{
    /** @var array */
    private $files = array();
    /** @var array */
    ...
    private $readBytes = array(
        ...
        Symfony_Process_Process::STDERR => 0,
    );
    /** @var bool */
    ...
    public function __construct($disableOutput, $input)
    {
        ...
        if (!$this->disableOutput) {
            ...
            // @see https://bugs.php.net/bug.php?id=51800
            $this->files = array(
                Symfony_Process_Process::STDOUT => tempnam(sys_get_temp_dir(), 'sf_proc_stdout'),
                Symfony_Process_Process::STDERR => tempnam(sys_get_temp_dir(), 'sf_proc_stderr'),
            );
     ...
     *
     * @param Symfony_Process_Process $process The process
     * @param $input
     *
     * @return Symfony_Process_Pipes_WindowsPipes
     */
    public static function create(Symfony_Process_Process $process, $input)
    {
        return new self($process->isOutputDisabled(), $input);
    }
