 ...
 * @internal
 */
class Symfony_Process_Pipes_UnixPipes extends Symfony_Process_Pipes_AbstractPipes
{
    /** @var bool */
    private $ttyMode;
    /** @var bool */
     ...
     *
     * @return Symfony_Process_Pipes_UnixPipes
     */
    public static function create(Symfony_Process_Process $process, $input)
    {
        return new self($process->isTty(), $process->isPty(), $input, $process->isOutputDisabled());
    }
}
