...
class ThemePluginFilesAddon extends AddonAbstract
{
    ...
    public function load_assets()
    {
        ...
        $src = $plugins_url . 'frontend/noop.js';
    ...
    public function get_strings()
    {
        $strings = [
            ...
            'cli_migrating_push'     => __('Uploading files', 'wp-migrate-db-pro-theme-plugin-files'),
            'cli_migrating_pull'     => __('Downloading files', 'wp-migrate-db-pro-theme-plugin-files'),
        ];
